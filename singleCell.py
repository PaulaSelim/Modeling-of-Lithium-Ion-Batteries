...
soc = solution["Negative electrode stoichiometry"].entries  # Correct variable name for SOC
temperature = np.mean(solution["Cell temperature [K]"].entries, axis=0) - 273.15  # Average across spatial points and convert to Celsius
