...
def run_experiment(current_amp):
    ...
    param["Ambient temperature [K]"] = 373.15  # 100°C
    ...
    # If temperature is a 2D array, convert to 1D (take the first row)
...
# Define standardized colors and linestyles for each C-rate
color_05C, ls_05C = 'black', ':'
color_1C,  ls_1C  = 'blue', '-'
color_2C,  ls_2C  = 'cyan', '--'
...
axs[0, 0].plot(cap_05C, volt_05C, color=color_05C, linestyle=ls_05C, linewidth=2, label='0.5C (2.5 A)')
axs[0, 0].plot(cap_1C, volt_1C, color=color_1C, linestyle=ls_1C, linewidth=2, label='1C (5.0 A)')
axs[0, 0].plot(cap_2C, volt_2C, color=color_2C, linestyle=ls_2C, linewidth=2, label='2C (10.0 A)')
...
axs[0, 1].plot(time_05C, SoC_05C, color=color_05C, linestyle=ls_05C, linewidth=2, label='0.5C (2.5 A)')
axs[0, 1].plot(time_1C, SoC_1C, color=color_1C, linestyle=ls_1C, linewidth=2, label='1C (5.0 A)')
axs[0, 1].plot(time_2C, SoC_2C, color=color_2C, linestyle=ls_2C, linewidth=2, label='2C (10.0 A)')
...
axs[1, 0].plot(time_05C, temp_05C, color=color_05C, linestyle=ls_05C, linewidth=2, label='0.5C (2.5 A)')
axs[1, 0].plot(time_1C, temp_1C, color=color_1C, linestyle=ls_1C, linewidth=2, label='1C (5.0 A)')
axs[1, 0].plot(time_2C, temp_2C, color=color_2C, linestyle=ls_2C, linewidth=2, label='2C (10.0 A)')
...
axs[1, 1].plot(time_05C, cap_05C, color=color_05C, linestyle=ls_05C, linewidth=2, label='0.5C (2.5 A)')
axs[1, 1].plot(time_1C, cap_1C, color=color_1C, linestyle=ls_1C, linewidth=2, label='1C (5.0 A)')
axs[1, 1].plot(time_2C, cap_2C, color=color_2C, linestyle=ls_2C, linewidth=2, label='2C (10.0 A)')
